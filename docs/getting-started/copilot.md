...
[GitHub Copilot](https://github.com/features/copilot) is a coding assistant. OpenADLC runs in it as an [APM](https://github.com/microsoft/apm) target, and Copilot is named as a harness in the ADLC spec.
...
- OpenADLC is in early development; Claude Code is the most exercised target today. For anything harness-specific, see the [APM docs](https://github.com/microsoft/apm) and Copilot's own docs.
