...
4. CHECKPOINT, consent: if the verdict is to be posted to a PR or tracker, before asking, write the checkpoint file (`type: post-review`, `checkpoints.md`). Present it and STOP for an explicit yes before posting. Persisting locally is free; posting is gated.
